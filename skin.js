...
// Pano2VR 7.1.6/20966
// Filename: arsa_arazi_menu.ggsk
// Generated 2024-11-22T00:12:24

function pano2vrSkin(player,base) {
	player.addVariable('vis_image_popup', 2, false, { ignoreInState: 0  });
	player.addVariable('info_w_picture', 1, 0, { ignoreInState: 0  });
	...
	this.addSkin=function() {
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		el=me._webpage=document.createElement('div');
		el.ggId="WebPage";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._webpage.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._webpage.ggUpdatePosition=function (useTransition) {
		}
		...
		me._webpage.appendChild(me._close_url);
		...
		hs+='cursor : default;';
		hs+='height : 20%;';
		hs+='left : calc(50% - ((72.1959% + 0px) / 2) - 10.6%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((20% + 0px) / 2) - 24%);';
		hs+='visibility : hidden;';
		hs+='width : 72.1959%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._webpage.appendChild(me._web_page);
		...
		me._webpage.appendChild(me._screen_tint_url);
		me.divSkin.appendChild(me._webpage);
		el=me._arsa_info=document.createElement('div');
		el.ggId="arsa_info";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._arsa_info.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._arsa_info.ggUpdatePosition=function (useTransition) {
		}
		...
		me._arsa_info.appendChild(me._screentint_info);
		...
		el.ggType='rectangle';
		hs ='';
		hs+='background : rgba(255,0,0,0.666667);';
		...
		me._information.appendChild(me._image_1);
		...
		hs+='cursor : default;';
		hs+='height : 100px;';
		hs+='left : calc(50% - ((250px + 4px) / 2) + 0px);';
		hs+='position : absolute;';
		hs+='top : 75px;';
		hs+='visibility : inherit;';
		hs+='width : 250px;';
		...
		me._arsa_info.appendChild(me._information);
		me.divSkin.appendChild(me._arsa_info);
		...
		me._dropdown_scrollarea__content.mousetouchend = e => {
			let inertiaInterval = setInterval(function() {
				me._dropdown_scrollarea.ggDragInertiaX *= 0.96;
				me._dropdown_scrollarea.ggDragInertiaY *= 0.96;
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 175px; background-color: rgba(128,128,128,0); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._dropdown_scrollarea__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 175px; background-color: rgba(0,0,0,1); pointer-events: auto;');
		...
		el.isDragging = function() {
			let scrollerParent = me._image_2;
		...
		me._dropdown_scrollarea__content.appendChild(me._image_2);
		...
		me._dropdown_menu_title_background.logicBlock_backgroundcolor = function() {
			...
			if (me._dropdown_menu_title_background.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me._dropdown_menu_title_background.ggCurrentLogicStateBackgroundColor == 0) {
					...
					me._dropdown_menu_title_background.style.backgroundColor="rgba(255,0,0,1)";
				}
			}
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		el=me._k=document.createElement('div');
		els=me._k__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="K";
		el.ggDx=0;
		...
		me._k.ggUpdatePosition=function (useTransition) {
		}
		me._compassring.appendChild(me._k);
		el=me._d=document.createElement('div');
		els=me._d__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="D";
		el.ggDy=0;
		...
		me._compassring.appendChild(me._d);
		el=me._g=document.createElement('div');
		els=me._g__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="G";
		el.ggDx=0;
		...
		me._g.ggUpdatePosition=function (useTransition) {
		}
		me._compassring.appendChild(me._g);
		el=me._b=document.createElement('div');
		els=me._b__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="B";
		el.ggDy=0;
		...
		me._compassring.appendChild(me._b);
		...
		el=me._tur_dugum=document.createElement('div');
		el.ggId="tur_dugum";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._tur_dugum.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._tur_dugum.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._tur_dugum);
		el=me._harita=document.createElement('div');
		el.ggFilter = '';
		el.ggFilteredIds = [];
		el.ggMapLayers = [];
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._harita.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._harita.logicBlock_position = function() {
			...
			if (me._harita.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._harita.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._harita.style.transition='right 500ms ease 0ms, bottom 500ms ease 0ms';
				if (me._harita.ggCurrentLogicStatePosition == 0) {
					me._harita.style.right='10px';
					me._harita.style.bottom='10px';
				}
				else {
					me._harita.style.right='-350px';
					me._harita.style.bottom='10px';
				}
			}
		}
		me._harita.logicBlock_position();
		me._harita.ggUpdatePosition=function (useTransition) {
			if (me._harita.ggMapNotLoaded == false) {
				me._harita.ggMap.invalidateSize(false);
			}
		}
		me.divSkin.appendChild(me._harita);
		el=me._harita_button=document.createElement('div');
		els=me._harita_button__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="harita_button";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._harita_button.ggUpdateText=function() {
			var params = [];
			var hs = player._("Harita G\xf6ster", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._harita_button.ggUpdateText();
		el.appendChild(els);
		me._harita_button.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._harita_button.logicBlock_text = function() {
			...
			if (me._harita_button.ggCurrentLogicStateText != newLogicStateText) {
				me._harita_button.ggCurrentLogicStateText = newLogicStateText;
				me._harita_button.style.transition='color 0s';
				if (me._harita_button.ggCurrentLogicStateText == 0) {
					if (me._harita_button.ggUpdateText) {
					me._harita_button.ggUpdateText=function() {
						var params = [];
						var hs = player._("Harita Gizle", params);
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
					...
					me._harita_button.ggUpdateText();
						...
						if (me._harita_button.ggUpdatePosition) me._harita_button.ggUpdatePosition();
					}
				}
				else {
					if (me._harita_button.ggUpdateText) {
		...
		me._harita_button.logicBlock_text();
		me._harita_button.logicBlock_textcolor = function() {
			...
			if (me._harita_button.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._harita_button.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._harita_button__text.style.transition='color 0s';
				if (me._harita_button.ggCurrentLogicStateTextColor == 0) {
					me._harita_button.style.color="rgba(0,0,127,1)";
				}
				else {
					me._harita_button.style.color="rgba(255,255,255,1)";
				}
			}
		}
		me._harita_button.logicBlock_textcolor();
		me._harita_button.onclick=function (e) {
			player.setVariableValue('vis_map', !player.getVariableValue('vis_map'));
		}
		me._harita_button.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._harita_button);
		...
		me._tt_enter_vr.logicBlock_position = function() {
			...
			if (me._tt_enter_vr.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._tt_enter_vr.ggCurrentLogicStatePosition == 0) {
					...
					me._tt_enter_vr.style.top = 'calc(50% - (0px / 2) - (0px / 2) + -25px)';
				}
				else {
					me._tt_enter_vr.style.left='-25px';
					me._tt_enter_vr.style.top='calc(50% - ((0px + 0px) / 2) - 32px)';
				}
			}
		}
		...
		me._compasspointer1.logicBlock_visible();
		me._beamdot.logicBlock_visible();
		me._harita.ggMarkerInstances=[];
		me._harita.ggLastNodeId=null;
		me._harita.ggMarkerArray=[];
		me._harita.ggGoogleMarkerArray=[];
		me._harita.ggLastZoom = -1;
		me._harita.ggLastLat = 0.0;
		me._harita.ggLastLng = 0.0;
		me._harita.ggRadar={ lastFov : -1, lastPan : -1, lastZoom : -1,activeNodeLatLng : null, poly : null }
		me._harita.ggRadar.update=function() {
			var radar=me._harita.ggRadar;
			var map=me._harita.ggMap;
			if (!map) return;
			var d2r = Math.PI/180 ;
			var r2d = 180/Math.PI ;
			...
			var gps;
			if (player.getMapType(me._harita.ggMapId) == 'web') {
				gps=player.getNodeLatLng();
			} else {
				gps=player.getNodeMapCoords(null, me._harita.ggMapId);
				pan -= me._harita.ggFloorplanNorth;
			}
			var filterpassed = true;
			var currentId = player.getCurrentNode();
			if (me._harita.ggFilteredIds.length > 0 && me._harita.ggFilteredIds.indexOf(currentId) == -1) filterpassed = false;
		...
		me._harita.ggTileAvailable=function(x, y, z) {
			var mapDetails = player.getMapDetails(me._harita.ggMapId);
		...
		me._harita.ggSetLayer=function(layerIndex) {
			if (typeof me._harita.ggMapLayers === 'object' && me._harita.ggMapLayers !== null && layerIndex >= 0 && layerIndex < Object.keys(me._harita.ggMapLayers).length) {
				me._harita.ggMap.removeLayer(me._harita.ggCurMap);
				me._harita.ggCurMap = me._harita.ggMapLayers[Object.keys(me._harita.ggMapLayers)[layerIndex]];
				me._harita.ggMap.addLayer(me._harita.ggCurMap);
			}
		}
		me._harita.ggInitMap=function(keepZoom) {
			var mapType = player.getMapType(me._harita.ggMapId);
			var mapDetails = player.getMapDetails(me._harita.ggMapId);
			if (!me._harita.ggMapId) return;
			if (!me._harita.ggMapId.startsWith('google') && Object.keys(mapDetails).length === 0) return;
			if (mapType == 'file') {
				me._harita.style.backgroundColor = mapDetails['bgcolor'];
				me._harita.ggFloorplanNorth = mapDetails['floorplannorth'];
			} else {
				me._harita.style.backgroundColor = '#fff';
			}
			var gps;
			if (player.getMapType(me._harita.ggMapId) == 'web') {
				gps=player.getNodeLatLng();
			...
			if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
				...
				activeNodeLatLng = L.latLng(me._harita.ggLastLat, me._harita.ggLastLng);
			}
			if (mapType == 'web') {
				if (me._harita.ggLastZoom == -1) me._harita.ggLastZoom = 14;
				var initZoom = keepZoom ? me._harita.ggLastZoom : 14;
				...
				me._harita.ggMap = L.map(me._harita, mapOptions).setView(activeNodeLatLng, initZoom);
				if (mapDetails.hasOwnProperty('maplimits') && (mapDetails['maplimits'].length == 4)) {
					...
					me._harita.ggMap.setMaxBounds(maxBounds);
					me._harita.ggMap.setMinZoom(me._harita.ggMap.getBoundsZoom(maxBounds) - 1);
				}
				if (mapDetails['mapprovider'] == 'openstreetmap') {
					if (mapDetails['mapstyle'] == 'streets') {
						L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{}).addTo(me._harita.ggMap);
					} else if (mapDetails['mapstyle'] == 'outdoors') {
						L.tileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png',{}).addTo(me._harita.ggMap);
					}
				} else if (mapDetails['mapprovider'] == 'mapbox') {
					if (mapDetails.hasOwnProperty('mapboxlayerstyleurls')) {
						me._harita.ggMapLayers = {};
						var firstCustMap;
						...
						if (!layerStyle.startsWith('mapbox:')) {
							...
							me._harita.ggMapLayers[mapDetails['mapboxlayernames'][layerIndex]] = custMap;
							if (layerIndex == 0) {
								me._harita.ggCurMap = custMap;
							}
						}
						var overlayMaps = {};
						L.control.layers(me._harita.ggMapLayers, overlayMaps).addTo(me._harita.ggMap);
						me._harita.ggCurMap.addTo(me._harita.ggMap);
					} else {
					...
					if (mapDetails.hasOwnProperty('customlayerurltemplates')) {
						...
						for (var layerIndex = 0; layerIndex < mapDetails['customlayerurltemplates'].length; layerIndex++) {
							...
							me._harita.ggMapLayers[mapDetails['customlayernames'][layerIndex]] = custMap;
							if (layerIndex == 0) {
								me._harita.ggCurMap = custMap;
							}
						}
						...
						L.control.layers(me._harita.ggMapLayers, overlayMaps).addTo(me._harita.ggMap);
						me._harita.ggCurMap.addTo(me._harita.ggMap);
						me._harita.ggMap.on('baselayerchange', function(event) {
							me._harita.ggMap.setMaxZoom(mapDetails['customlayermaxzooms'][mapDetails['customlayernames'].indexOf(event.name)]);
						});
					} else {
						L.tileLayer(mapDetails['mapurltemplate'],{ maxZoom: mapDetails['mapmaxzoom']}).addTo(me._harita.ggMap);
					}
				}
				me._harita.ggMap.on('zoom', function() {
					me._harita.ggRadar.update();
				});
			} else if (mapType == 'file') {
				me._harita.ggCalculateFloorplanDimInDeg(mapDetails);
				var mapCenter = activeNodeLatLng;
				if (mapCenter.lat == 0.0 && mapCenter.lng == 0.0) {
					mapCenter.lat = -me._harita.mapHeightInDeg / 2;
					mapCenter.lng = me._harita.mapWidthInDeg / 2;
				}
				if (me._harita.ggLastZoom == -1) me._harita.ggLastZoom = 7;
				var initZoom = keepZoom ? me._harita.ggLastZoom : 7;
				var mapOptions = {
					zoom: initZoom,
					minZoom: 7,
				...
				var MapLayer = L.TileLayer.extend({
					getTileUrl: function(coords){
						if (me._harita.ggTileAvailable(coords.x, coords.y, coords.z)) {
							return basePath + 'images/maptiles/' + me._harita.ggMapId + '/' + coords.z + '/' + coords.x + '_' + coords.y + '.' + mapDetails['tileformat'];
						} else {
							return '';
						}
					}
				...
				mapLayer.addTo(me._harita.ggMap);
				me._harita.ggMap.on('move zoom', function() {
					me._harita.ggCheckBounds(mapDetails);
					me._harita.ggRadar.update();
				});
				me._harita.ggCheckBounds(mapDetails);
			}
			me._harita.ggMapNotLoaded = false;
		}
		me._harita.ggClearMap=function() {
		me._harita.ggClearMapMarkers();
		if (me._harita.ggMap) me._harita.ggMap.remove();
		me._harita.ggMap = null;
		me._harita.ggMapNotLoaded = true;
		}
		me._harita.ggClearMapMarkers=function() {
			me._harita.ggLastActivMarker = null;
			var id,marker;
			var markers=me._harita.ggGoogleMarkerArray;
			for (id in markers) {
				if (markers.hasOwnProperty(id)) {
					marker=markers[id];
					marker.removeFrom(me._harita.ggMap);
				}
			}
			me._harita.ggGoogleMarkerArray=[];
		}
		me._harita.ggCenterNode=function(nodeId) {
			if (!me._harita.ggMap) return;
			var gps;
			if (player.getMapType(me._harita.ggMapId) == 'web') {
				gps=player.getNodeLatLng(nodeId);
			} else {
				gps=player.getNodeMapCoords(nodeId, me._harita.ggMapId);
			}
			if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
				var markerLocation = L.latLng(gps[0], gps[1]);
				me._harita.ggMap.panTo(markerLocation, {animate: false});
			}
		}
		me._harita.ggFitBounds=function(force) {
			if (me._harita.ggMapNotLoaded) return;
			if (!me._harita.ggMap) return;
			if (me._harita.ggMarkerBounds.isValid()) {
				if (me._harita.ggMarkerInstances.length > 1 || Object.getOwnPropertyNames(me._harita.ggGoogleMarkerArray).length > 1) {
					me._harita.ggMap.zoomOut(1, {animate: false});
					me._harita.ggMap.fitBounds(me._harita.ggMarkerBounds, {padding: [30, 30], animate: false});
				} else {
					me._harita.ggMap.setView(me._harita.ggMarkerBounds.getCenter(), me._harita.ggMap.getZoom());
					if (player.getMapType(me._harita.ggMapId) == 'web') {
						me._harita.ggMap.setZoom(18);
					} else {
						me._harita.ggMap.setZoom(7);
					}
				}
			}
		}
		me._harita.ggInitMapMarkers=function(updateMapBounds) {
			if (!me._harita.ggMap) return;
			me._harita.ggClearMapMarkers();
			var ids=player.getNodeIds();
			me._harita.ggFilteredIds = [];
			if (me._harita.ggFilter != '') {
				var filter = me._harita.ggFilter.split(',');
				for (i=0; i < ids.length; i++) {
					var nodeId = ids[i];
					var nodeData = player.getNodeUserdata(nodeId);
					for (var j=0; j < filter.length; j++) {
						if (nodeData['tags'].indexOf(filter[j].trim()) != -1) me._harita.ggFilteredIds.push(nodeId);
					}
				}
				if (me._harita.ggFilteredIds.length > 0) ids = me._harita.ggFilteredIds;
			}
			var marker;
			var markerLocation;
			me._harita.ggMarkerBounds = L.latLngBounds();
			var currentId = player.getCurrentNode();
			for(var i=0;i<ids.length;i++) {
				...
				if (player.getMapType(me._harita.ggMapId) == 'web') {
					...
					gps=player.getNodeMapCoords(id, me._harita.ggMapId);
				}
				if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
					...
					marker.addTo(me._harita.ggMap);
					me._harita.ggGoogleMarkerArray[id] = marker;
					me._harita.ggMarkerBounds.extend(markerLocation);
				}
			}
			if (ids.length > 1 && me._harita.ggMarkerBounds.isValid() && updateMapBounds) {
				me._harita.ggFitBounds(false);
			}
			skin.updateSize(me._harita);
			this.ggLastActivMarker = null;
			if (this.ggUpdateConditionNodeChange) this.ggUpdateConditionNodeChange();
			this.ggRadar.lastFov = -1;
			this.ggRadar.update();
		}
		me._harita.ggChangeMap=function(mapId) {
			var newMapType = player.getMapType(mapId)
			if (newMapType == 'file') {
				return;
			}
			me._harita.ggMapId = mapId;
			if (!me._harita.ggMapNotLoaded) {
				me._harita.ggLastZoom = me._harita.ggMap.getZoom();
				me._harita.ggLastLat = me._harita.ggMap.getCenter().lat;
				me._harita.ggLastLng = me._harita.ggMap.getCenter().lng;
				me._harita.ggClearMap();
				me._harita.ggInitMap(true);
				me._harita.ggInitMapMarkers(false);
			}
		}
		me._harita.ggCalculateFloorplanDimInDeg=function(mapDetails) {
			var mapAR = mapDetails['width'] / mapDetails['height'];
			...
			if (mapDetails['width'] >= mapDetails['height']) {
				...
				me._harita.mapWidthInDeg = tileInDeg * (tmpWidth / 256);
				me._harita.mapHeightInDeg = me._harita.mapWidthInDeg / mapAR;
			} else {
				var tmpHeight = mapDetails['height'];
				while (tmpHeight > 256) {
					tmpHeight /= 2;
				}
				me._harita.mapHeightInDeg = tileInDeg * (tmpHeight / 256);
				me._harita.mapWidthInDeg = me._harita.mapHeightInDeg * mapAR;
			}
		}
		me._harita.ggInCheckBounds=false;
		me._harita.ggCheckBounds=function(mapDetails) {
			if (me._harita.ggInCheckBounds) return;
			me._harita.ggInCheckBounds = true;
			var mapCenter = me._harita.ggMap.getCenter();
			var currentZoom = me._harita.ggMap.getZoom();
			var pixelInDeg = 360.0 / (Math.pow(2, currentZoom) * 256)
			var xOffset = (me._harita.clientWidth / 2.0) * pixelInDeg;
			var yOffset = (me._harita.clientHeight / 2.0) * pixelInDeg;
			var x = mapCenter.lng;
			var y = mapCenter.lat;
			var xTemp = x;
			var yTemp = y;
			if (me._harita.mapWidthInDeg < me._harita.clientWidth * pixelInDeg) {
				var xMargin = (me._harita.clientWidth * pixelInDeg - me._harita.mapWidthInDeg) / 2;
				if (x < me._harita.mapWidthInDeg / 2 - xMargin) x = me._harita.mapWidthInDeg / 2 - xMargin;
				if (x > me._harita.mapWidthInDeg / 2 + xMargin) x = me._harita.mapWidthInDeg / 2 + xMargin;
			} else {
				if (x > me._harita.mapWidthInDeg - xOffset) x = me._harita.mapWidthInDeg - xOffset;
				if (x < xOffset) x = xOffset;
			}
			if (me._harita.mapHeightInDeg < me._harita.clientHeight * pixelInDeg) {
				var yMargin = (me._harita.clientHeight * pixelInDeg - me._harita.mapHeightInDeg) / 2;
				if (y < -me._harita.mapHeightInDeg / 2 - yMargin) y = -me._harita.mapHeightInDeg / 2 - yMargin;
				if (y > -me._harita.mapHeightInDeg / 2 + yMargin) y = -me._harita.mapHeightInDeg / 2 + yMargin;
			} else {
				if (y < -me._harita.mapHeightInDeg + yOffset) y = -me._harita.mapHeightInDeg + yOffset;
				if (y > -yOffset) y = -yOffset;
			}
			if (x != xTemp || y != yTemp) {
				var newCenter = L.latLng(y, x);
				me._harita.ggMap.setView(newCenter, me._harita.ggMap.getZoom(), {animate: false});
			}
			me._harita.ggInCheckBounds = false;
		}
		me._harita.logicBlock_position();
		...
		player.addListener('changenode', function(event) {
			...
			me._beamdot.logicBlock_visible();
			me._harita.logicBlock_position();
			if (me._harita.ggLastActivMarker) {
				if (me._harita.ggLastActivMarker._div.ggDeactivate) me._harita.ggLastActivMarker._div.ggDeactivate();
			}
			var id=player.getCurrentNode();
			if (me.ggMarkerArray) {
			var marker=me._harita.ggMarkerArray[id];
			if (marker) {
				if (marker._div.ggActivate) marker._div.ggActivate();
			}
			me._harita.ggLastActivMarker=marker;
			}
			if (!me._harita.ggMapNotLoaded) {
				me._harita.ggCenterNode();
			}
			if (player.getMapType(me._harita.ggMapId) == 'file') {
				var coords = player.getNodeMapCoords(id, me._harita.ggMapId);
				if (coords.length < 2) {
					var mapId = player.getMapContainingNode(id);
					if (mapId != '') {
							me._harita.ggChangeMap(mapId);
					}
				}
			}
			me._harita.ggLastNodeId = id;
			me._harita.ggRadar.update();
			me._harita_button.logicBlock_text();
			me._harita_button.logicBlock_textcolor();
		});
		...
		player.addListener('configloaded', function(event) {
			...
			me._harita.logicBlock_position();
			me._harita.ggClearMap();
			me._harita.ggInitMap(false);
			me._harita.ggInitMapMarkers(true);
			me._harita_button.logicBlock_text();
			me._harita_button.logicBlock_textcolor();
			me._tt_enter_vr.logicBlock_position();
		});
	...
	function SkinCloner_dropdown_cloner_Class(nodeId, parentScope, ggParent, parameter) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		hs ='';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) - 34px);';
		hs+='position : absolute;';
		...
		me._ht_url.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('vis_userdata', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')) == true)) || 
				((player.getVariableValue('vis_image_popup') == true)) || 
				((player.getVariableValue('vis_info_popup') == true)) || 
				((player.getVariableValue('vis_video_popup_file', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')) == true)) || 
				((player.getVariableValue('vis_video_popup_url', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')) == true)) || 
				((player.getVariableValue('vis_video_popup_vimeo', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')) == true)) || 
				((player.getVariableValue('vis_video_popup_youtube', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')) == true)) || 
				((player.getVariableValue('vis_website') == true))
			)
			{
				newLogicStateVisible = 0;
		...
		hs=basePath + 'images/ht_url_image.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'Csx7hwzSY0gjUXWEtxbYDmmntR5fj4XkvjKWc8wkiiElHCaQecMnZNlMpXxWrOW3w00A/gRpfj4P6ViKGixCylGaAfwLSXJ4q8V6fzxdJVMREn88PQcpiJnE/8DH078L/Bctg86godjJ3AAAAABJRU5ErkJggg==';
		...
		hs+='cursor : pointer;';
		hs+='height : 50px;';
		hs+='left : calc(50% - ((50px + 0px) / 2) - 5px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((50px + 0px) / 2) - 17px);';
		hs+='visibility : inherit;';
		hs+='width : 50px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
